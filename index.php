	...
	<div class="wrapper">
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown messages-menu">
							<a class="dropdown-toggle">
								<span>
									<b>
										Perpustakaan (VSGA Web Developer)
									</b>
								</span>
							</a>
						</li>
        ...
        ?>
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li>
								<a href="?page=MyApp/cetak">
									<i class="fa fa-file"></i>Kartu Anggota</a>
							</li>
						</ul>
					</li>
          ...
          switch ($hal) {
              ...
              case 'kembali':
				...
				case 'MyApp/cetak';
					...
					break;
				case 'MyApp/cetak_agt';
					include "admin/cetak/cetak_agt.php";
					break;
    ...
    ?>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy;
				<a href="https://instagram.com/cahya_diantoni">Cahya Diantoni</a>.</strong> VSGA.
		</footer>
